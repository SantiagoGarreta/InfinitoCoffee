...
public sealed class AuthorizationEndpointTests
{
    public static IEnumerable<object[]> PrivateEndpointMatrix()
    {
        ...
        var endpoints = new[]
        {
            ...
            Endpoint("orders-active", HttpStatusCode.OK, UserRole.Administrator, UserRole.Kitchen),
            Endpoint("orders-start-preparation", HttpStatusCode.OK, UserRole.Administrator, UserRole.Kitchen),
            Endpoint("orders-mark-ready", HttpStatusCode.OK, UserRole.Administrator, UserRole.Kitchen),
            Endpoint("orders-deliver", HttpStatusCode.OK, UserRole.Administrator, UserRole.Kitchen),
            Endpoint("orders-cancel", HttpStatusCode.OK, UserRole.Administrator, UserRole.Cashier),
